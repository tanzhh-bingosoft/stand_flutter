 ...
 */
public final class StandFlutterInjector {

  private static StandFlutterInjector instance;
  private static boolean accessed;

  /**
   * Use {@link Builder} to specify members to be injected via the static {@code
   * FlutterInjector}.
   *
   * <p>This can only be called at the beginning of the program before the {@link #instance()} is
   * accessed.
   */
  public static void setInstance(@NonNull StandFlutterInjector injector) {
    if (accessed) {
   ...
   */
  public static StandFlutterInjector instance() {
    accessed = true;
    if (instance == null) {
  ...
  /**
   * Returns the {@link FlutterLoader} instance to use for the
   ...
   * StandFlutterInjector#setInstance(StandFlutterInjector)}.
   *
  ...
  public static final class Builder {
    ...
    private void fillDefaults() {
      ...
      if (flutterLoader == null) {
        flutterLoader = new StandFlutterLoader(flutterJniFactory.provideFlutterJNI(), executorService);
      }
      // DeferredComponentManager's intended default is null.
    }

    /**
     * Builds a {@link StandFlutterInjector} from the builder. Unspecified properties will have
     * reasonable defaults.
     */
    public StandFlutterInjector build() {
      fillDefaults();

      return new StandFlutterInjector(
