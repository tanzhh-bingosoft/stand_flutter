...
public class StandFlutterLoader extends FlutterLoader {
     ...
     */
    public StandFlutterLoader(@NonNull FlutterJNI flutterJNI) {
        this(flutterJNI, StandFlutterInjector.instance().executorService());
    }
     ...
     */
    public StandFlutterLoader(@NonNull FlutterJNI flutterJNI, @NonNull ExecutorService executorService) {
            ...
            Callable<InitResult> initTask =
                    new Callable<InitResult>() {
                        ...
                        public InitResult call() {
                            ...
                            try {
                                StandResourceExtractor resourceExtractor = initResources(appContext);
        ...
        try {
            ...
            if (BuildConfig.DEBUG || BuildConfig.JIT_RELEASE) {
                String snapshotAssetPath =
                        result.dataDirPath + File.separator + flutterApplicationInfo.flutterAssetsDir + "2";
                ...
                shellArgs.add(
                        "--" + AOT_SHARED_LIBRARY_NAME + "=libapp2.so");
//                shellArgs.add(
//                        "--" + AOT_SHARED_LIBRARY_NAME + "=" + flutterApplicationInfo.aotSharedLibraryName);
     ...
     */
    private StandResourceExtractor initResources(@NonNull Context applicationContext) {
        StandResourceExtractor resourceExtractor = null;
        if (BuildConfig.DEBUG || BuildConfig.JIT_RELEASE) {
            ...
            resourceExtractor =
                    new StandResourceExtractor(dataDirPath, packageName, packageManager, assetManager);
    ...
    public String findAppBundlePath() {
        return flutterApplicationInfo.flutterAssetsDir + "2";
    }

    /**
     * Returns the file name for the given asset. The returned file name can be used to access the
     * asset in the APK through the {@link AssetManager} API.
     *
...
//        boolean automaticallyRegisterPlugins = (boolean) Reflector.get(flutterApplicationInfo, "automaticallyRegisterPlugins");
//        return automaticallyRegisterPlugins;
    ...
    private String fullAssetPathFrom(@NonNull String filePath) {
        return flutterApplicationInfo.flutterAssetsDir + "2" + File.separator + filePath;
    }
